<template>
  ...
  >
    ...
    <!-- 锁定列的表头 -->
    <div
      class="fixed-header-right"
      style="width:120px;overflow:hidden;position:absolute;top:0px;right:0px;z-index:999;"
      ref="fixedRH"
    >
      <table cellspacing="0" cellpadding="0" style="width:100%;">
        <colgroup>
    ...
    <!-- 锁定的表体 -->
    <div
      :style="{height:scrollHeight,top:fixedHtop+'px'}"
      class="fixed-right-body"
      style="width:120px;position:absolute;right:0px;background:#fff;top:0px;"
    >
      <tableBody
        ref="scrollBody"
        :bodyData="data"
